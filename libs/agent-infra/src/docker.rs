...
//! container) can reach them by container name via Docker's embedded DNS. This
//! is the local-dev counterpart to the Fly.io and Firecracker backends — the
//! same coordinator loop drives real matches without any cloud infra.
//!
