            ...
            html! {
                div class="flex flex-col justify-end mt-4 gap-4" {
                    ...
                    div class="flex justify-end" {
                        (new_agent_modal())
                        // a href="/agents/new" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" {
                        //     svg class="w-6 h-6 text-white scale-75 dark:text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" {
